...
class DBFFormat:
    ...
    def export_set(cls, DataTable):
        """Returns DBF representation of a DataTable"""
        ...
        for fieldname, field_value in zip(DataTable.headers, first_row):
        ...
        for row in DataTable:
            ...
            for fieldname, field_value in zip(DataTable.headers, row):
    ...
    def import_set(cls, dset, in_stream, headers=True):
        """Returns a DataTable from a DBF stream."""
